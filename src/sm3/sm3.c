...
int WBCRYPTO_sm3_init(WBCRYPTO_sm3_context *c)
{
    memset(c, 0, sizeof(*c));
    c->A = SM3_A;
    c->B = SM3_B;
...
void sm3_block_data_order(WBCRYPTO_sm3_context *ctx, const void *p, size_t num)
{
...
int WBCRYPTO_sm3(const unsigned char *msg, size_t msglen, unsigned char *digest){
    ...
    WBCRYPTO_sm3_update(&ctx, msg, msglen);
