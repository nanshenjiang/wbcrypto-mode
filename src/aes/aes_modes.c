...
WBCRYPTO_fpe_mac_context *WBCRYPTO_aes_fpe_mac_init(WBCRYPTO_aes_context *key, const char *twkbuf, size_t twklen, unsigned int radix)
{
    WBCRYPTO_fpe_mac_context *ctx = WBCRYPTO_fpe_mac_init(twkbuf, twklen, radix, key, (block128_f)WBCRYPTO_aes_encrypt);
    return ctx;
}